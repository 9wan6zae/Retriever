...
public final class Texture {
  ...
  public void updateWithDepthImageOnGlThread(final Frame frame) {
    try {
      ...
      width = depthImage.getWidth(); //160
      height = depthImage.getHeight(); //90
      ...
      short[] yRow = new short[width];
      shortDepthBuffer.position(45 * rowStride);
      shortDepthBuffer.get(yRow, 0, width);

      short depthSample = yRow[80];
      short depthRange = (short) (depthSample & 0x1FFF);
      short depthConfidence = (short) ((depthSample >> 13) & 0x7);
      float depthPercentage = depthConfidence == 0 ? 1.f : (depthConfidence - 1) / 7.f;

      if(depthPercentage > 0.7){
        System.out.println("====================================");
        System.out.println("depth : " + depthRange / 1000.0);
        System.out.println("====================================");
      }
